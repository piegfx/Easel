...
public static class EaselMath
{
    ...
    /// along the given control points, taken as <see cref="Vector2T"/>.
    /// </summary>
    ...
    /// </remarks>
    /// <param name="p0">A <see cref="Vector2T"/> representing the first control point of the curve.</param>
    /// <param name="p1">A <see cref="Vector2T"/> representing the second control point of the curve.</param>
    /// <param name="p2">A <see cref="Vector2T"/> representing the third control point of the curve.</param>
    /// <returns>A <see cref="Vector2T"/> result position along the curve, based on t.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <param name="p1">A <see cref="Vector2T"/> representing the second control point of the curve.</param>
    /// <param name="p2">A <see cref="Vector2T"/> representing the third control point of the curve.</param>
    /// <param name="p3">A <see cref="Vector2T"/> representing the fourth control point of the curve.</param>
    /// <returns>A <see cref="Vector2T"/> result position along the curve, based on t.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
