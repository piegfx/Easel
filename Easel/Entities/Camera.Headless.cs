...
// TODO: Work out the best way to handle the camera in headless instances.
...
public class Camera : Entity
{
    ...
    private void GenerateProjectionMatrix()
    {
        ProjectionMatrix = ProjectionType switch
        {
            ...
            ProjectionType.Orthographic => Matrix4x4.CreateOrthographicOffCenter(0, _orthoSize.X, _orthoSize.Y, 0, -1, 1),
