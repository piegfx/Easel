...
public class DeferredRenderer : I3DRenderer
{
    ...
    public DeferredRenderer()
    {
        ...
        PositionTexture = device.CreateTexture<byte>(new TextureDescription(TextureType.Texture2D, texWidth, texHeight, PixelFormat.R8G8B8A8_UNorm, true, 1, TextureUsage.ShaderResource | TextureUsage.Framebuffer), null);
        NormalTexture = device.CreateTexture<byte>(new TextureDescription(TextureType.Texture2D, texWidth, texHeight, PixelFormat.R8G8B8A8_UNorm, true, 1, TextureUsage.ShaderResource | TextureUsage.Framebuffer), null);
        AlbedoTexture = device.CreateTexture<byte>(new TextureDescription(TextureType.Texture2D, texWidth, texHeight, PixelFormat.R8G8B8A8_UNorm, true, 1, TextureUsage.ShaderResource | TextureUsage.Framebuffer), null);
        SpecularTexture = device.CreateTexture<byte>(new TextureDescription(TextureType.Texture2D, texWidth, texHeight, PixelFormat.R8G8B8A8_UNorm, true, 1, TextureUsage.ShaderResource | TextureUsage.Framebuffer), null);
